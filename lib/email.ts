                ...
                <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #FFFFFF; border: 1px solid #D9D9D9; border-radius: 8px; overflow: hidden;">
                  ...
                  <tr>
                    <td style="padding: 40px 30px; background-color: #FFFFFF;">
                      ...
                      <p style="margin: 20px 0; font-size: 14px; line-height: 1.6; color: #575757;">If you have any questions, please contact us at <a href="mailto:customerservice@zargeofficial.com" style="color: #B8960C; text-decoration: none; font-weight: 500;">customerservice@zargeofficial.com</a></p>
                    </td>
                  </tr>
